...
export default function Home(){
    return(
        ...
        <div className=" bg-wall1  bg-contain h-auto w-full flex justify-center items-center">
          ...
          <div className="grid grid-cols-1 gap-10 w-2/3 md:grid-cols-2 my-40">   <Card number="1"/>
             <Card number="2"/> 
             <Card number="3"/> 
             <Card number="4"/>
             <Card number="4"/>

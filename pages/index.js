...
export default function Home() {
  return (
    <div className='w-auto h-screen bg-blue-400 text-black flex justify-center items-center'><div className=' w-1/4 rounded-lg h-2/3 bg-white flex-initial flex items-center flex-col  justify-evenly'>
